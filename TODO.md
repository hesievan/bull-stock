...
| 维度 | 状态 | 说明 |
|------|------|------|
| 数据层 | ✅ 基本就绪 | 全市场 PE/PB 回填完成 (2769天, 1099万行, 0错误) |
...
### 数据完整性
- [x] 确认全市场 PE/PB 回填完成 (检查 `data/backfill_full_market.log`)
- [x] 验证回填后各日期股票数: 2015年应≥2000只, 2024年应≥5000只
- [x] 跑一次完整回测 (`scripts/backtest.py`) 验证全市场数据下的指标表现
- [x] 检查 stock_daily 中 peTTM/pbMRQ/pct_change 有效率 (目标: >90%)
