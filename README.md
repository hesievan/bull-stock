...
## 回测验证（V2 引擎，2026-08 修复基线重算）

| 日期 | 市场状态 | V2 综合热度 | 信号 |
|------|---------|------------|------|
| 2015-06-12 | 牛市顶 | **97.6** 🔴 | 正确触发红区，信号极强 |
| 2018-12-28 | 熊底 | **5.7** 🟢 | 正确触发绿区，极度低估 |
| 2020-07-10 | 牛市启动 | **77.8** 🔴 | 正确提前预警红区 |
| 2021-02-18 | 牛市顶 | **78.4** 🔴 | ✅ 正确触发红区（V1 仅橙区，V2 修正） |
| 2024-02-05 | 熊底 | **24.7** 🟢 | 正确触发绿区 |
| 2024-10-08 | 脉冲顶 | **53.1** 🟡 | 正确识别为脉冲，非真顶 |
| 2026-06-24 | 震荡市 | **73.0** 🔴 | 两融市值比处 10 年 99.6% 分位（杠杆极值），修复后正确预警 |
| 2026-06-25 | 震荡市 | **73.1** 🔴 | 同上 |
