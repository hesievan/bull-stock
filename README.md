...
A股牛市热度指数是一个量化分析工具，通过6个维度、19个子指标综合评估A股市场的整体热度水平。系统每日自动更新，通过飞书通知推送风险预警。
...
| index_daily | 16,692 | 2014-12-29 ~ 2026-06-12 | 6大指数行情 |
...
│   ├── indicators/
│   │   ├── calculator.py          # 编排入口 (6维度加权合成)
│   │   ├── utils.py               # 共享工具函数 (百分位/评分/数值转换)
